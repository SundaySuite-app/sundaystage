...
- [~] Phase 11 — Power AI features (11.2 service-planning assistant done; 11.2 translation overlay + 11.1 semantic search deferred)
  ...
  - Deferred: translation overlay (needs a translation-storage model + live-display changes; overlaps the SundayEdit translate work) and 11.1 semantic search (needs embeddings/pgvector)
